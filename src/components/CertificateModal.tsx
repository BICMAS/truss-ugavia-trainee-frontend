...
certificateUrl
 ...
 const handleLinkedInShare = () => {
    const text = `I just successfully completed the "${courseTitle}" course at Truss Ugavi! #Learning #ProfessionalDevelopment #TrussUgavi`;
  ...
  const generatePDF = (): boolean => {
    try {
     ...
     doc.setDrawColor(30, 41, 59);
      ...
      doc.setFontSize(16);
      doc.text('Truss Ugavi Director', width - 50, bottomY - 5, { align: 'center' });
           ...
           className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 shadow-inner ring-8 transition-all duration-500 ${
             isDownloaded
               ...
               : isError
                 ...
                 : 'bg-brand-green/10 text-brand-green ring-brand-green/10'
           }`}
         >
            {isProcessing ? (
          ...
          {!isDownloaded && !isProcessing && (
           <div className="space-y-3">
              <button
               ...
               className="w-full brand-btn-primary py-3.5 flex items-center justify-center gap-2 active:scale-[0.98]"
              >
