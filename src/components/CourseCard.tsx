...
export const CourseCard: React.FC<CourseCardProps> = ({
  ...
  > = {
    ...
    [CourseStatus.InProgress]: {
      label: "In progress",
      badge: "bg-brand-yellow/20 text-brand-green-dark",
      bar: "bg-brand-yellow",
    },
  ...
  return (
    <div
      className={`brand-card overflow-hidden flex flex-col transition-all hover:shadow-md hover:border-brand-green/20 ${
        ...
        <div className="mt-auto space-y-3">
          ...
          <div className="flex items-center justify-between border-t border-slate-100 pt-3">
            ...
            <div className="flex items-center gap-2">
              {isCompleted && (
                <div className="text-brand-yellow-dark flex items-center gap-1 text-xs font-medium bg-brand-yellow/15 px-2 py-1 rounded-full">
